...
const CONVERSATIONS = [
  {
    ...
    lastMessage: 'Hey, I was thinking we could meet up to discuss our living preferences?',
    timestamp: '10:30 AM',
    unread: 2,
  },
  {
    ...
    lastMessage: 'That sounds great! I\'m also looking for a place close to campus.',
    timestamp: 'Yesterday',
    unread: 0,
  },
  {
    ...
    lastMessage: 'I\'m a pretty quiet roommate, but I do enjoy having friends over occasionally.',
